...
다음 강의에서는 실전 중심의 자동화 과정, 콘텐츠 제작 흐름, 비즈니스별 프롬프트 전략 등 더 깊이 있는 워크숍을 계획하고 있습니다.`
    ...
    'db-group': {
        ...
        category: '기업교육',
        date: '2024.05',
        location: 'DB인재개발원 (경기도 광주시 도척면)',
        participants: 'DB그룹 계열사 실무진 (3~6년차)',
        image: '/assets/images/db.png',
        result: '만족도 평균 이상',
        tags: ['기업교육', 'AI 리터러시', '업무 자동화', '데이터 시각화', 'DB그룹'],
        summary: 'DB손해보험, DB생명, DB하이텍 등 DB그룹 계열사 실무진 대상 경력단계별 AX교육',
        seoDescription: 'DB인재개발원에서 진행한 DB그룹 계열사 실무진 대상 AI 역량강화 교육. 무료 AI도구를 활용한 실무 자동화와 데이터 시각화 교육 사례.',
        sections: [
            {
                title: '광주 도척에서 마주한 실전형 교육',
                content: `2024년 5월 15일부터 16일까지, 경기도 광주시 도척면에 위치한 DB인재개발원에서 '경력단계별 AX교육'이 진행되었습니다.

이번 교육은 DB손해보험, DB생명, DB하이텍 등 DB그룹 계열사 실무진 3~6년차 직원 대상으로 한 그룹 차원의 핵심 역량 강화 프로그램이었습니다.

총 7시간에 걸친 강의는 단순한 청강 중심의 구성이 아니라, 직접 활용할 수 있는 AI 기반 실습 중심의 커리큘럼으로 구성되었습니다.

교육 내내 몰입도는 매우 높았고, 현장에서는 실제 실무 적용 가능성에 대한 질문과 논의가 끊이지 않았습니다.`
            },
            {
                title: '무료 AI도구로 만드는 실무 자동화와 데이터 시각화',
                content: `이번 DB인재개발원 AX교육의 가장 큰 특징은 "무료 기반의 AI도구만으로도 업무 자동화와 데이터 시각화가 가능하다"는 실전적 메시지였습니다.

실제 커리큘럼은 다음과 같은 세 가지 핵심 영역으로 구성되었습니다.

다양한 최신 생성형 AI를 활용한 문서 자동화 및 콘텐츠 기획과 사례 분석

Google 제미나이, GROK3 등을 활용한 데이터 분석과 시각화 실습과 보고서 실전 작성

부서 내 협업과 커뮤니케이션을 효율화하는 워크플로우 자동화 사례 소개

특히 "무료 툴로도 이 정도 퀄리티가 나온다고요?"라는 반응이 나올 만큼, 실습 중심 구성은 교육 효과를 극대화했습니다.`
            },
            {
                title: '"이건 바로 써야겠네요"',
                content: `강의가 끝나고도 교육생들의 관심은 멈추지 않았습니다.

"업무에 바로 적용해보고 싶다", "이건 실무에서 정말 필요했던 내용이었다" 등 실질적 반응들이 이어졌고, 강의 후 곧바로 실습 복습 요청과 자료 문의가 이어졌습니다.

교육 후 설문에서는 "이해가 쉽고 강사가 수강생을 계속 챙겨주는 점이 좋았다"는 피드백이 많았고, 전체 만족도는 평균 이상으로 집계되었습니다.

특히, 한 교육생은 "유료 도구보다 이 강의에서 소개한 무료 기반 접근이 더 현실적이었다"고 평가해주셨습니다.`
            },
            {
                title: '기업 교육이야말로, AI 활용의 진짜 현장이었습니다',
                content: `이번 DB인재개발원 AX교육은 제가 처음으로 진행한 2일짜리 기업 대상 집체 교육이었습니다.

이틀이라는 시간 동안, 단순한 정보 전달이 아닌 '수강생들과 계속 호흡을 맞추며 진행하는 함께 만드는 교육'의 중요성을 체감했습니다.

제가 준비한 내용보다 더 많은 질문이 쏟아졌고, 수강생의 반응을 실시간으로 반영해 강의 흐름을 조정하며 유연하게 대응했습니다.

그 결과, 실습 중 수강생들이 "이제 막연했던 AI가 이해됐다"는 반응을 주셨고, 그 말 한마디에 강사로서의 보람을 느낄 수 있었습니다.

이번 강의를 통해 저는 기업 교육에서의 AI 리터러시 확산 가능성을 분명히 확인했습니다.

많은 분들이 "이런 교육이 더 자주 있었으면 좋겠다", "각 부서 맞춤형 버전도 듣고 싶다"는 의견을 남겨주셨습니다.`
            },
        ],
        closing: `DB인재개발원 AX교육은 단순한 도구 소개를 넘어, AI 활용의 실전성과 실현 가능성을 체감할 수 있는 시간으로 구성되었습니다. 무료 기반 도구만으로도 업무 자동화, 콘텐츠 생성, 데이터 시각화까지 실현할 수 있다는 사실에 수강생 여러분은 실제로 깊은 관심과 만족을 보여주셨습니다. 저는 이번 교육을 통해 단순히 정보를 전달하는 것을 넘어, AI를 실무에서 '왜', '어떻게' 활용해야 하는지에 대한 방향성을 함께 정립하고 싶었습니다. 도구보다 중요한 건, 이걸 어떻게 써야 하는지를 아는 것입니다.`
    }
};
